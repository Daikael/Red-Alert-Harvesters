...
expect(info_src:find('"version": "2.1.12"', 1, true) ~= nil, "pack version is 2.1.12")
...
expect(bay_src:find('resource_categories = {"basic-solid", "basic-solid-tiberium"}', 1, true) ~= nil, "slave miner uses real resource categories")
...
expect(io.open("data-final-fixes.lua", "r") ~= nil, "data-final-fixes attaches tiberium resource categories")
