...
expect(ChunkIndex.overlay_class({empty = false, items = {["iron-ore"] = true}}, true, 5, true) == "green", "green beats yellow and red")
expect(ChunkIndex.overlay_class({empty = false}, false, 1, false) == "yellow", "border is yellow")
expect(ChunkIndex.overlay_class({empty = false}, false, 0, true) == "yellow", "harvester is yellow")
...
expect(ChunkIndex.overlay_class({empty = true}, false, 2, false) == "yellow", "border beats purple")
...
expect(modes[2] == "chart-zoomed-in", "overlay draws chart-zoomed-in (zoomed map / minimap)")
